...
export class FilterProvider {
  ...
  getData(filter) {
    if (filter === 'Education') {
      this.educationData = this.getResponse(this.educationRequest, filter);
      return this.educationData;
    } else if (filter == 'Work') {
      this.workData = this.getResponse(this.workRequest, filter);
      return this.workData;
    } else if (filter == 'Housing') {
      this.housingData = this.getResponse(this.housingRequest, filter);
      return this.housingData;
    } else if (filter == 'Cash') {
      this.cashData = this.getResponse(this.cashRequest, filter);
      return this.cashData;
    } else if (filter == 'Health') {
      this.healthData = this.getResponse(this.healthRequest, filter);
      return this.healthData;
    } else if (filter == 'Other') {
      this.otherData = this.getResponse(this.otherRequest, filter);
